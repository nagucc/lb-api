(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('babel-polyfill'), require('express'), require('cookie-parser'), require('body-parser'), require('debug'), require('babel-runtime/regenerator'), require('babel-runtime/helpers/asyncToGenerator'), require('babel-runtime/core-js/promise'), require('babel-runtime/helpers/classCallCheck'), require('babel-runtime/helpers/createClass'), require('ssh2'), require('babel-runtime/core-js/json/stringify')) :
  typeof define === 'function' && define.amd ? define(['babel-polyfill', 'express', 'cookie-parser', 'body-parser', 'debug', 'babel-runtime/regenerator', 'babel-runtime/helpers/asyncToGenerator', 'babel-runtime/core-js/promise', 'babel-runtime/helpers/classCallCheck', 'babel-runtime/helpers/createClass', 'ssh2', 'babel-runtime/core-js/json/stringify'], factory) :
  (factory(global.babelPolyfill,global.express,global.cookieParser,global.bodyParser,global.debug,global._regeneratorRuntime,global._asyncToGenerator,global._Promise,global._classCallCheck,global._createClass,global.ssh2,global._JSON$stringify));
}(this, (function (babelPolyfill,express,cookieParser,bodyParser,debug,_regeneratorRuntime,_asyncToGenerator,_Promise,_classCallCheck,_createClass,ssh2,_JSON$stringify) { 'use strict';
